...
const Fujiwara = () => {
    return (
        <div class="modal fade" id="fujiwara" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content tairaModal">
      <div class="modal-body">
        <h3 className='modalTitle'>Fujiwara</h3>
